...
import { offerEmailPreviewHtml } from "@/lib/worldwide/offer-email-template";

export const metadata: Metadata = {
  title: "Email de oferta | Preview",
  description: "Preview do email de oferta 70% OFF.",
};

export default function OfferEmailPreviewPage() {
  return (
    <main className="min-h-screen bg-[#e9eef7] px-4 py-8 text-[#021126] sm:px-8">
      ...
      <iframe
        className="mx-auto block h-[920px] w-full max-w-[760px] rounded-[24px] border border-[#d6deec] bg-white shadow-[0_24px_80px_rgba(2,17,38,0.15)]"
        srcDoc={offerEmailPreviewHtml}
        title="Preview do email de oferta"
      />
    </main>
  );
}
